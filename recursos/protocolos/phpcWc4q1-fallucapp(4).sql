...
INSERT INTO `tipo_fallas` (`idTipoF`, `tipo`) VALUES
(1, 'Falla física'),
(2, 'Falla de envío de datos'),
(3, 'Falla de servidor'),
...
--
ALTER TABLE `tipos_dispositivos`
  MODIFY `idTipoDisp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tipo_fallas`
--
ALTER TABLE `tipo_fallas`
  MODIFY `idTipoF` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- Constraints for table `protocolos`
--
ALTER TABLE `protocolos`
  ADD CONSTRAINT `protocolos_ibfk_1` FOREIGN KEY (`idTipoF`) REFERENCES `tipo_fallas` (`idTipoF`);
COMMIT;
